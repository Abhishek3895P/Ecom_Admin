...
<EditProductModel
  ...
  product={product}
  categories={Categoryredux} // Your list of categories
      ...
      <div className="mx-auto">
        ...
        <Breadcrumb
          items={[
            ...
            { label: "Prtoduct Detail", href: null },
          ]}
        />
        <div className="my-4">
        ...
        {Loading ? (
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-50 overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-6">
              ...
              {/* Product Info */}
              <div>
                <FiEdit2 onClick={()=>setIsEditModalOpen(true)}/>
                {/* Title and Status */}
                ...
                <div className="mb-6">
                  <div className="flex items-center">
                    <p className="font-bold text-gray-500 text-2xl mr-2">₹ </p>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    {product.specifications.map((spec, index) => (
                      <div key={index} className="bg-gray-50 rounded-lg p-3">
                        <div className="text-sm text-gray-500">{spec.key}</div>
                  ...
                  {product.measurement && (
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <div className="font-medium">{product.measurement}</div>
                      </div>
                    </div>
                  )}
                </div>
